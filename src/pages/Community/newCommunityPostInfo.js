    ...
    <NewPostContentInfoDiv>
      <TitleDiv height="2rem" marginTop="2rem">
        <TitleBox width="90%" height="2rem ">
          <TitleSpan fontSize="1rem" lineHeight="2rem">
            입주 가능 날짜
          </TitleSpan>
        </TitleBox>
        <TitleBox width="90%" height="2rem ">
      ...
      <FirstSection startDateOnChange={startDateOnChange} />
      ...
      <TitleDiv height="3rem" marginTop="1.5rem">
        <TitleBox width="25%" height="3rem">
          <TitleSpan fontSize="1rem" lineHeight="3rem">
            방 개수
          </TitleSpan>
        </TitleBox>
        <TitleBox width="25%" height="3rem">
      ...
      <TitleDiv height="2rem" marginTop="1.5rem">
        <TitleSpan fontSize="1rem" marginRight="2rem">
          집 해시태그
        </TitleSpan>
      </TitleDiv>
